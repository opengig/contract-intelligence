    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon-sm" asChild>
          <Link href="/contracts"><ArrowLeft className="size-4" /></Link>
        </Button>
        <div className="flex-1">
          ...
          <p className="text-muted-foreground text-sm">
            ...
            {contract.effectiveFrom &&
              ` · Effective ${new Date(contract.effectiveFrom).toLocaleDateString('en-IN')}`}
          </p>
        </div>
          ...
          {isProcessing ? (
            <div className="flex flex-col items-center gap-3 py-16">
              ...
              <p className="text-muted-foreground">
                AI is extracting contract terms…
              </p>
  ...
  return (
    <tr className="border-b last:border-0 hover:bg-muted/20">
      <td className="px-6 py-3">
        ...
        {term.route && (
          <p className="text-xs text-muted-foreground">{term.route}</p>
        )}
      </td>
